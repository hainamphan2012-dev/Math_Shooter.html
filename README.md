...
*   **Đường dẫn file:** `01_Projects/Math_Shooter.html`
...
│   ├── Math_Shooter.html    # Game bắn súng Galaxy Math Defender
...
1.  **Tải mã nguồn** về máy hoặc nhân bản (clone) repo này:
    ...
    ```
2.  **Mở Game:** Điều hướng vào thư mục `01_Projects/` và **click đúp chuột** vào một trong các file `Math_Shooter.html`, `Math_Quest.html`, hoặc `Math_Quiz.html` để chơi trực tiếp trên trình duyệt (Chrome, Edge, Firefox...).
